...
export type StorageHash =
  StorageHashBase<'c35d156b4d6aa87dbe5473b537b44f710019c586a568cb1ff912843122ff692d'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Job: {
      ...
      readonly feedbackText: CodecTypes['pg/text@1']['output'];
      readonly source: CodecTypes['pg/text@1']['output'] | null;
      readonly userTier: CodecTypes['pg/text@1']['output'] | null;
    ...
    readonly JobResult: {
      ...
      readonly sentiment: CodecTypes['pg/text@1']['output'];
      readonly category: CodecTypes['pg/text@1']['output'];
      readonly summary: CodecTypes['pg/text@1']['output'];
      readonly actionItem: CodecTypes['pg/text@1']['output'];
      readonly urgencyScore: CodecTypes['pg/int4@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
  };
...
export type FieldInputTypes = {
  readonly public: {
    readonly Job: {
      ...
      readonly feedbackText: CodecTypes['pg/text@1']['input'];
      readonly source: CodecTypes['pg/text@1']['input'] | null;
      readonly userTier: CodecTypes['pg/text@1']['input'] | null;
    ...
    readonly JobResult: {
      ...
      readonly sentiment: CodecTypes['pg/text@1']['input'];
      readonly category: CodecTypes['pg/text@1']['input'];
      readonly summary: CodecTypes['pg/text@1']['input'];
      readonly actionItem: CodecTypes['pg/text@1']['input'];
      readonly urgencyScore: CodecTypes['pg/int4@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
  };
          ...
          readonly Job: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly feedbackText: { readonly column: 'feedbackText' };
                readonly source: { readonly column: 'source' };
                readonly userTier: { readonly column: 'userTier' };
          ...
          readonly JobResult: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly actionItem: { readonly column: 'actionItem' };
                readonly urgencyScore: { readonly column: 'urgencyScore' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
